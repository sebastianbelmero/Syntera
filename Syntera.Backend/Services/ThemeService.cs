...
public sealed class ThemeService : IThemeService
{
    ...
    public async Task<Models.Dtos.Auth.ThemeDto> GetThemeAsync(Guid siteId, CancellationToken ct = default)
    {
        var cacheKey = $"theme:{siteId}";
        if (_cache.TryGetValue<Models.Dtos.Auth.ThemeDto>(cacheKey, out var cached))
        {
        ...
        else
        {
            ...
            dto = new Models.Dtos.Auth.ThemeDto(
    ...
    public static Models.Dtos.Auth.ThemeDto PlatformDefault() => new(
    ...
    private static Models.Dtos.Auth.ThemePalette ParsePalette(string? json, bool defaultPalette)
    {
        ...
        try
        {
            ...
            return new Models.Dtos.Auth.ThemePalette(
    ...
    public static Models.Dtos.Auth.ThemePalette DefaultLight() => new(
    ...
    public static Models.Dtos.Auth.ThemePalette DefaultDark() => new(
