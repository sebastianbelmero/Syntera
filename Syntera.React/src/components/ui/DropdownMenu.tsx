...
/**
 * DropdownMenu — Radix UI wrapper with Syntera brand styling.
 * Ported in-house so the AppHeader user menu (and any future dropdown
 * menus in the app) is owned entirely by the Syntera.React codebase.
 */
